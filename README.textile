...
@wget --no-check-certificate https://raw.github.com/freecastle/oh-my-zsh/master/tools/install.sh -O - | sh@
...
@curl -L https://raw.github.com/freecastle/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@

h3. The manual way

1. Clone the repository:

@git clone git://github.com/freecastle/oh-my-zsh.git ~/.oh-my-zsh@
